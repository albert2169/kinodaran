...
import 'package:kinodaran/presentation/single_movie_screen/single_movie_screen.dart';
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final movieModel = imageSectionModel.images[index];
                  final imagePath = movieModel.path;
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (_) =>
                              SingleMovieScreen(movieModel: movieModel)));
                    },
                    child: Column(
                      children: [
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                if (imageSectionModel.isForContinueWatching)
                                  Text(
                                    '${movieModel.episode}:${movieModel.seria}',
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
